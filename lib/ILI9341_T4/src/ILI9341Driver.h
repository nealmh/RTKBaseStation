...
public:
    ...
    *    for positions {x[0], x[239], y[0], y[319]} in orientation 0.
    **/
    void setTouchCalibration(float touchCalibration[6] = nullptr);
    ...
    * array.
    **/
    bool getTouchCalibration(float touchCalibration[6]);
...
//                while ((_pimxrt_spi->FSR & 0x1f)); // wait for output fifo to be empty.
    ...
    ***********************************************************************************************************/
    ...
    volatile float _touch_calib[6];             // touch calibration value
